public class Main {
    ...
    public static String[] combos_int(char[][] inputarray, int pos, String[] resultSoFar) {
        ...
        for (char ch : pos_array) {
            for (String res: resultSoFar) {
                    resultArray[j] = Character.toString(ch) + res;
                    j++;
            }
        }
        return resultArray;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            System.out.println("fib " + Integer.toString(i)  + " : " + fibonacci(i));

        }

        for (int i = 0; i < 10; i++) {
            System.out.println("d fib " + Integer.toString(i)  + " : " + dynamic_fibonacci(i));

        }
        char[][] x1 = {{'a','b', 'c'}, {'d', 'e', 'f'}, {'g', 'h', 'k'}};
        String[] r1 = combos(x1);
        System.out.println("R1 is" + java.util.Arrays.toString(r1));
        System.out.println(("R1 has size: "  + Integer.toString(r1.length)));
